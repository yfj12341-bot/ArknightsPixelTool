...
class SamplePalettesTest {

    @Test
    fun arknights40HasExactOrderAndValues() {
        val expected = listOf(
        ...
        assertEquals(40, SamplePalettes.arknights40.size)
        assertEquals(expected, SamplePalettes.arknights40.colors)
    }
}
